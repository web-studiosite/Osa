...
-- 3. TABELA DE PERFIS DE UTILIZADORES (RBAC - EMAIL & PIN)
...
-- Índices para autenticação rápida por email
...
INSERT INTO user_profiles (id, email, pin, full_name, role, phone) VALUES
  ('usr-admin', 'admin@osa.co.mz', '1234', 'Dr. Alberto Mondlane (CEO / Administrador)', 'admin', '+258 84 000 0001'),
  ('usr-junior', 'gestor@osa.co.mz', '1234', 'Sara Cossa (Supervisora de Operações)', 'junior_admin', '+258 84 000 0002'),
  ('usr-caixa', 'caixa01@osa.co.mz', '1234', 'Mateus Tembe (Operador de Caixa 01)', 'cashier', '+258 84 000 0003')
